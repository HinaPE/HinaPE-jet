#ifndef HINAPE_UNIVERSAL_ARRAY_DATA_H
#define HINAPE_UNIVERSAL_ARRAY_DATA_H
...
struct NativeArrayHandle : public UT_Vector3TArrayHandle<std::vector<real>>
{
	...
	UT_Vector3T<real> geto(int off) const override { return {internal->data() + off * 3}; }
...
#endif //HINAPE_UNIVERSAL_ARRAY_DATA_H
